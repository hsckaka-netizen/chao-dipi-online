...
test("AI benchmark deals are repeatable and keep both teams on identical cards", () => {
  const first = createAiBenchmarkRoom({ seed: "paired-deal", playerCount: 5, bankerSeat: 2, doglegSeat: 4 });
  const second = createAiBenchmarkRoom({ seed: "paired-deal", playerCount: 5, bankerSeat: 2, doglegSeat: 4 });
